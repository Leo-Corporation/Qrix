...
export default function SettingsPage() {
  ...
  function isSettings(object: unknown): object is Settings {
    return (
      ...
      object !== null &&
      typeof (object as Record<string, unknown>).barcodeType === 'string' &&
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col space-y-4 p-4">
        ...
        <CardContent>
          ...
          <div className="flex flex-wrap">
            <div
              ...
              className={`bg-accent m-2 flex cursor-pointer items-center space-x-2 overflow-hidden rounded-lg border-2 pr-2 ${
        ...
        <CardContent>
          <div className="grid grid-cols-[auto_1fr] grid-rows-6 items-center gap-2">
            ...
            <Input
              ...
              min={1}
              max={120}
              className="border-input h-[28px] w-[75px] border"
              type="number"
            />
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex space-x-2">
            ...
            >
              <span className="font-bold">{t('export-settings')}</span>
            </Link>
            <Button
              size="nav"
              variant="outline"
